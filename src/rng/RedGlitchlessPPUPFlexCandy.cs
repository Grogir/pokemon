public class RedGlitchlessPPUPFlexCandy : RedBlueForceComparisons
{
    public RedGlitchlessPPUPFlexCandy(bool silphbar = true, bool altmenus = true)
    {
        // RecordAndTime("red-glitchless-ppupflexcandyx");
        // RecordAndTime("red-glitchless-ppupflexcandyaltx");
        ...
        CacheState("fly", () => {
            ...
            Buy("X ACCURACY", 11, "X SPECIAL", 5, "X SPEED", 4);
        ...
        CacheState("flute", () => {
            ...
            // ItemSwap("FULL RESTORE", "X ACCURACY");
            Fly("LavenderTown");
