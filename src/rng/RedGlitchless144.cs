public class RedGlitchless144 : RedBlueForceComparisons
{
    public RedGlitchless144(bool silphBar = true)
    {
        // RecordAndTime("red-glitchless-144");
        ...
        CacheState("fly", () => {
            ...
            Buy("X ACCURACY", 11, "X SPECIAL", 3, "X SPEED", 6);
